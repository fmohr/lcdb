...
export DEEPHYPER_BENCHMARK_CSV="/Users/romainegele/Documents/Research/LCDB/lcdb/publications/2023-neurips/experiments/alcf/polaris/densenn/output/lcdb.workflow.keras.DenseNNWorkflow/14/42-42-42/results.csv.gz"
...
# export reduction_factors=(1.25 1.5 2 3 9 18)
export reduction_factors=(27)
