...
export DEEPHYPER_BENCHMARK_CSV="/Users/romainegele/Documents/Research/LCDB/lcdb/publications/2023-neurips/experiments/alcf/polaris/knn/output/lcdb.workflow.sklearn.KNNWorkflow/3/42-42-42/results.csv.gz"
...
# export stop_steps=(16 32 64 128 256 512 1024 2048 2556)
export stop_steps=(128 256 512 1024 2048 2556)
...
exec_search () {
    ...
    python -m dhexp.run --problem $problem \
        ...
        --stopper $stopper \
        --stopper-kwargs "{'max_steps': 2556, 'stop_step': $stop_step}" \
        --max-evals $max_evals
}
